...
export declare class ZetaChainClient {
    ...
    getQuote: (this: ZetaChainClient, inputAmount: string, inputZRC20: string, outputZRC20: string) => Promise<{
        amount: any;
        decimals: any;
    }>;
    getWithdrawFeeInInputToken: (this: ZetaChainClient, inputZRC20: string, outputZRC20: string) => Promise<{
        amount: any;
        decimals: any;
    }>;
    getRefundFee: (this: ZetaChainClient, inputZRC20: string) => Promise<{
        amount: any;
        decimals: any;
    }>;
    getZRC20FromERC20: (this: ZetaChainClient, erc20: string) => Promise<any>;
    getZRC20GasToken: (this: ZetaChainClient, network: string) => Promise<any>;
}
