...
class ZetaChainClient {
    ...
    constructor(params) {
        ...
        this.getQuote = _1.getQuote;
        this.getWithdrawFeeInInputToken = _1.getWithdrawFeeInInputToken;
        this.getRefundFee = _1.getRefundFee;
        this.getZRC20FromERC20 = _1.getZRC20FromERC20;
        this.getZRC20GasToken = _1.getZRC20GasToken;
