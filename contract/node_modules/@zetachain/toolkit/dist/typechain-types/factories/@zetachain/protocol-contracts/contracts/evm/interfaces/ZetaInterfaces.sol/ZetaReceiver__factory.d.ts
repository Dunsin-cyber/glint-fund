...
import type { ZetaReceiver, ZetaReceiverInterface } from "../../../../../../../@zetachain/protocol-contracts/contracts/evm/interfaces/ZetaInterfaces.sol/ZetaReceiver";
export declare class ZetaReceiver__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ZetaReceiver;
}
